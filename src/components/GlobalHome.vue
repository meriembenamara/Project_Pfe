                    ...
                    <div class="col-lg-11">
                        <div class="hero__caption">
                            <div class="hero-text1">
                                <a href="estimateplan"><span @click="openFileInput" data-animation="fadeInUp" data-delay=".3s">Estimer plan</span></a>
                            </div>
                            <h1 data-animation="fadeInUp" data-delay=".5s">Estimation</h1>
                            <div class="stock-text" data-animation="fadeInUp" data-delay=".8s">
                                <h2>avancée</h2>
                                <h2>avancée</h2>
                            </div>
                            <div class="hero-text2 mt-110" data-animation="fadeInUp" data-delay=".9s">
                                <span><a>Estimer temps</a></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="support-company-area fix pt-10">
    <div class="support-wrapper align-items-end">
        ...
        <section class="contact-with-area" style="background-image: url('/assets/img/gallery/section-bg2.jpg');">
            <div class="container">
                <div class="row">
        ...
        <div class="count-area">
            <div class="container">
                <div class="count-wrapper count-bg" style="background-image: url('/assets/img/gallery/section-bg3.png');">
