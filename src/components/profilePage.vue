    ...
    <div>
     ...
     <!--================Blog Area =================-->
          ...
          <div class="d-flex justify-content-between align-items-center">
            <h4 class="font-weight-bold py-3 mb-2 mt-2">Paramètres du compte</h4>
            <div class="text-blue-500">
              <div class="d-flex align-items-center mt-2" @click="confirmDelete(user._id)">
                ...
                <span class="text-blue-500 mr-2 ml-1 -mb-3">
            ...
            <div class="row no-gutters row-bordered row-border-light">
              <div class="col-md-3 pt-0">
                <div class="list-group list-group-flush account-settings-links">
                  <a class="list-group-item list-group-item-action active" data-toggle="list" href="#account-general">Informations Générales</a>
                  <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-info">Informations Personnelles</a>
                    ...
                    <div class="card-body pb-2">
                      ...
                      <div class="form-group">
                        ...
                        <input
                          type="password"
                          class="form-control"
                          placeholder="Entrez voter nouveau mot de passe"
                      ...
                      <div class="form-group">
                        ...
                        <input
                          ...
                          v-model="user.conf_new_password"
                        />
                      </div>
                    </div>
                  </div>
...
export default {
  ...
  methods: {
    async deleteUser(userId) {
      try {
        ...
        if (response.status === 200) {
          ...
          console.error(`Failed to delete user with ID ${userId}:`, response.data);
        }
      } catch (error) {
    ...
    async getuserData() {
      try {
        const response = await axios.get(`http://localhost:5000/api/users/66460653ea52b95a4dd38a1b`);
